...
describe('CertificateService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        CertificateService,
        { provide: getRepositoryToken(VehicleCertificate), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for certificates', async () => {
  ...
  it('should handle scenario 2 for certificates', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for certificates', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for certificates', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for certificates', async () => {
    repository.find.mockResolvedValue([]);
