...
describe('InspectionService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        InspectionService,
        { provide: getRepositoryToken(InspectionReport), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for inspections', async () => {
  ...
  it('should handle scenario 2 for inspections', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for inspections', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for inspections', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for inspections', async () => {
    repository.find.mockResolvedValue([]);
