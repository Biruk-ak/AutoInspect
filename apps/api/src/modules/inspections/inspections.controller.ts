...
export class InspectionController {
  ...
  @ApiOperation({ summary: 'Create inspections record' })
  create(@Body() dto: CreateInspectionDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create inspections records' })
  bulkCreate(@Body() dto: BulkCreateInspectionDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List inspections records' })
  ...
  @ApiOperation({ summary: 'Count inspections by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent inspections records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export inspections as CSV' })
  exportCsv(@Query() query: QueryInspectionDto) {
  ...
  @Get(':id')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Get inspections by id' })
  ...
  @ApiOperation({ summary: 'Update inspections' })
  update(
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusInspectionDto, @CurrentUser() user: { id: string }) {
