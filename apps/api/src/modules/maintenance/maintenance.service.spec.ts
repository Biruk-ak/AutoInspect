...
describe('MaintenanceService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        MaintenanceService,
        { provide: getRepositoryToken(MaintenanceRecord), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for maintenance', async () => {
  ...
  it('should handle scenario 2 for maintenance', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for maintenance', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for maintenance', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for maintenance', async () => {
    repository.find.mockResolvedValue([]);
