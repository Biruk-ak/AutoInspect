...
describe('BookingService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        BookingService,
        { provide: getRepositoryToken(InspectionBooking), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for bookings', async () => {
  ...
  it('should handle scenario 2 for bookings', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for bookings', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for bookings', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for bookings', async () => {
    repository.find.mockResolvedValue([]);
