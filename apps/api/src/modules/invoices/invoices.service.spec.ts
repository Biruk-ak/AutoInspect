...
describe('InvoiceService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        InvoiceService,
        { provide: getRepositoryToken(InvoiceDocument), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for invoices', async () => {
  ...
  it('should handle scenario 2 for invoices', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for invoices', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for invoices', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for invoices', async () => {
    repository.find.mockResolvedValue([]);
