...
export class InvoiceController {
  ...
  @ApiOperation({ summary: 'Create invoices record' })
  ...
  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create invoices records' })
  bulkCreate(@Body() dto: BulkCreateInvoiceDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List invoices records' })
  ...
  @ApiOperation({ summary: 'Count invoices by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent invoices records' })
  recent(
  ...
  exportCsv(@Query() query: QueryInvoiceDto) {
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusInvoiceDto, @CurrentUser() user: { id: string }) {
