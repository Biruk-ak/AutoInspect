...
export class InspectorController {
  ...
  @ApiOperation({ summary: 'Create inspectors record' })
  create(@Body() dto: CreateInspectorDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create inspectors records' })
  bulkCreate(@Body() dto: BulkCreateInspectorDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List inspectors records' })
  findAll(@Query() query: QueryInspectorDto) {
    return this.service.findAll(query);
  }

  @Get('stats/by-status')
  @Roles('admin', 'garage', 'inspector')
  @ApiOperation({ summary: 'Count inspectors by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent inspectors records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export inspectors as CSV' })
  exportCsv(@Query() query: QueryInspectorDto) {
  ...
  @Get(':id')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Get inspectors by id' })
  ...
  @ApiOperation({ summary: 'Update inspectors' })
  update(
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusInspectorDto, @CurrentUser() user: { id: string }) {
