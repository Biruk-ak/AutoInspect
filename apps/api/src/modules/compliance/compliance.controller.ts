...
export class ComplianceController {
  ...
  create(@Body() dto: CreateComplianceDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create compliance records' })
  bulkCreate(@Body() dto: BulkCreateComplianceDto, @CurrentUser() user: { id: string }) {
  ...
  findAll(@Query() query: QueryComplianceDto) {
    return this.service.findAll(query);
  }

  @Get('stats/by-status')
  @Roles('admin', 'garage', 'inspector')
  @ApiOperation({ summary: 'Count compliance by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent compliance records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export compliance as CSV' })
  exportCsv(@Query() query: QueryComplianceDto) {
  ...
  @Get(':id')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Get compliance by id' })
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusComplianceDto, @CurrentUser() user: { id: string }) {
