...
export class GarageController {
  ...
  @ApiOperation({ summary: 'Create garages record' })
  create(@Body() dto: CreateGarageDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create garages records' })
  bulkCreate(@Body() dto: BulkCreateGarageDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List garages records' })
  ...
  @ApiOperation({ summary: 'Count garages by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent garages records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export garages as CSV' })
  exportCsv(@Query() query: QueryGarageDto) {
  ...
  @Get(':id')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Get garages by id' })
  ...
  @ApiOperation({ summary: 'Update garages' })
  update(
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusGarageDto, @CurrentUser() user: { id: string }) {
