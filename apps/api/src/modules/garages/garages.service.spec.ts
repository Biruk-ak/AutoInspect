...
describe('GarageService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        GarageService,
        { provide: getRepositoryToken(GarageProfile), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for garages', async () => {
  ...
  it('should handle scenario 2 for garages', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for garages', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for garages', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for garages', async () => {
    repository.find.mockResolvedValue([]);
