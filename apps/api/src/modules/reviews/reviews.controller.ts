...
export class ReviewController {
  ...
  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create reviews records' })
  bulkCreate(@Body() dto: BulkCreateReviewDto, @CurrentUser() user: { id: string }) {
  ...
  @ApiOperation({ summary: 'Count reviews by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent reviews records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export reviews as CSV' })
  exportCsv(@Query() query: QueryReviewDto) {
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusReviewDto, @CurrentUser() user: { id: string }) {
