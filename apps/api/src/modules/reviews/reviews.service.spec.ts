...
describe('ReviewService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ReviewService,
        { provide: getRepositoryToken(ServiceReview), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for reviews', async () => {
  ...
  it('should handle scenario 2 for reviews', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for reviews', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for reviews', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for reviews', async () => {
    repository.find.mockResolvedValue([]);
