...
describe('PaymentService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        PaymentService,
        { provide: getRepositoryToken(PaymentTransaction), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for payments', async () => {
  ...
  it('should handle scenario 2 for payments', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for payments', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for payments', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for payments', async () => {
    repository.find.mockResolvedValue([]);
