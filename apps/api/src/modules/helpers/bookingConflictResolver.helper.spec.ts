import { BookingConflictResolverHelper } from './bookingConflictResolver.helper';

describe('BookingConflictResolverHelper', () => {
  const helper = new BookingConflictResolverHelper();
