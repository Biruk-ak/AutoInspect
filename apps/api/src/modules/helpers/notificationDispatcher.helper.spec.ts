import { NotificationDispatcherHelper } from './notificationDispatcher.helper';

describe('NotificationDispatcherHelper', () => {
  const helper = new NotificationDispatcherHelper();
