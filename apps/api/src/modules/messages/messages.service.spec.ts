...
describe('MessageService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        MessageService,
        { provide: getRepositoryToken(ChatMessage), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for messages', async () => {
  ...
  it('should handle scenario 2 for messages', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for messages', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for messages', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for messages', async () => {
    repository.find.mockResolvedValue([]);
