...
describe('DocumentService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        DocumentService,
        { provide: getRepositoryToken(DocumentFile), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for documents', async () => {
  ...
  it('should handle scenario 2 for documents', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for documents', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for documents', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for documents', async () => {
    repository.find.mockResolvedValue([]);
