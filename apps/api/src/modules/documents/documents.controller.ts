...
export class DocumentController {
  ...
  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create documents records' })
  bulkCreate(@Body() dto: BulkCreateDocumentDto, @CurrentUser() user: { id: string }) {
  ...
  @ApiOperation({ summary: 'Count documents by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent documents records' })
  recent(
  ...
  exportCsv(@Query() query: QueryDocumentDto) {
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusDocumentDto, @CurrentUser() user: { id: string }) {
