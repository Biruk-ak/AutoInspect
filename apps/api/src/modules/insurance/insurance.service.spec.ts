...
describe('InsuranceService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        InsuranceService,
        { provide: getRepositoryToken(InsurancePolicy), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for insurance', async () => {
  ...
  it('should handle scenario 2 for insurance', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for insurance', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for insurance', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for insurance', async () => {
    repository.find.mockResolvedValue([]);
