...
describe('PhotoService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        PhotoService,
        { provide: getRepositoryToken(InspectionPhoto), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for photos', async () => {
  ...
  it('should handle scenario 2 for photos', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for photos', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for photos', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for photos', async () => {
    repository.find.mockResolvedValue([]);
