...
describe('SchedulingService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        SchedulingService,
        { provide: getRepositoryToken(ScheduleSlot), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for scheduling', async () => {
  ...
  it('should handle scenario 2 for scheduling', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for scheduling', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for scheduling', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for scheduling', async () => {
    repository.find.mockResolvedValue([]);
