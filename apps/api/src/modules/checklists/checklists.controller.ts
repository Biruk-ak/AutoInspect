...
export class ChecklistController {
  ...
  @ApiOperation({ summary: 'Create checklists record' })
  create(@Body() dto: CreateChecklistDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create checklists records' })
  bulkCreate(@Body() dto: BulkCreateChecklistDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List checklists records' })
  findAll(@Query() query: QueryChecklistDto) {
    return this.service.findAll(query);
  }

  @Get('stats/by-status')
  @Roles('admin', 'garage', 'inspector')
  @ApiOperation({ summary: 'Count checklists by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent checklists records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export checklists as CSV' })
  exportCsv(@Query() query: QueryChecklistDto) {
  ...
  @Get(':id')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Get checklists by id' })
  ...
  @ApiOperation({ summary: 'Update checklists' })
  update(
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusChecklistDto, @CurrentUser() user: { id: string }) {
