...
describe('VehicleService', () => {
  ...
  it('should handle scenario 1 for vehicles', async () => {
  ...
  it('should handle scenario 2 for vehicles', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for vehicles', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for vehicles', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for vehicles', async () => {
    repository.find.mockResolvedValue([]);
