...
describe('AnalyticsService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AnalyticsService,
        { provide: getRepositoryToken(AnalyticsSnapshot), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for analytics', async () => {
  ...
  it('should handle scenario 2 for analytics', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for analytics', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for analytics', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for analytics', async () => {
    repository.find.mockResolvedValue([]);
