...
export class AuditController {
  ...
  @ApiOperation({ summary: 'Create audit record' })
  create(@Body() dto: CreateAuditDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create audit records' })
  bulkCreate(@Body() dto: BulkCreateAuditDto, @CurrentUser() user: { id: string }) {
  ...
  @ApiOperation({ summary: 'Count audit by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent audit records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export audit as CSV' })
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusAuditDto, @CurrentUser() user: { id: string }) {
