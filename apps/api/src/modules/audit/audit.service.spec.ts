...
describe('AuditService', () => {
  ...
  it('should handle scenario 1 for audit', async () => {
  ...
  it('should handle scenario 2 for audit', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for audit', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for audit', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for audit', async () => {
    repository.find.mockResolvedValue([]);
