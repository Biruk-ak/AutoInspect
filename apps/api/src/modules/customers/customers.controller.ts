...
export class CustomerController {
  ...
  @ApiOperation({ summary: 'Create customers record' })
  ...
  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create customers records' })
  bulkCreate(@Body() dto: BulkCreateCustomerDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List customers records' })
  ...
  @ApiOperation({ summary: 'Count customers by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent customers records' })
  recent(
  ...
  exportCsv(@Query() query: QueryCustomerDto) {
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusCustomerDto, @CurrentUser() user: { id: string }) {
