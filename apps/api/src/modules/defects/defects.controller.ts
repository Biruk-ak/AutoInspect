...
export class DefectController {
  ...
  @ApiOperation({ summary: 'Create defects record' })
  create(@Body() dto: CreateDefectDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create defects records' })
  bulkCreate(@Body() dto: BulkCreateDefectDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List defects records' })
  ...
  @ApiOperation({ summary: 'Count defects by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent defects records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export defects as CSV' })
  exportCsv(@Query() query: QueryDefectDto) {
  ...
  @Get(':id')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Get defects by id' })
  ...
  @ApiOperation({ summary: 'Update defects' })
  update(
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusDefectDto, @CurrentUser() user: { id: string }) {
