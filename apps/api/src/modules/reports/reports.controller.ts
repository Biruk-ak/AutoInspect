...
export class ReportController {
  ...
  @ApiOperation({ summary: 'Create reports record' })
  ...
  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create reports records' })
  bulkCreate(@Body() dto: BulkCreateReportDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List reports records' })
  ...
  @ApiOperation({ summary: 'Count reports by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent reports records' })
  recent(
  ...
  exportCsv(@Query() query: QueryReportDto) {
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusReportDto, @CurrentUser() user: { id: string }) {
