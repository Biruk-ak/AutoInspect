...
import {
  ...
  BulkUpdateStatusAppointmentDto,
...
export class AppointmentController {
  ...
  @ApiOperation({ summary: 'Create appointments record' })
  create(@Body() dto: CreateAppointmentDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create appointments records' })
  bulkCreate(@Body() dto: BulkCreateAppointmentDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List appointments records' })
  ...
  @ApiOperation({ summary: 'Count appointments by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent appointments records' })
  recent(
  ...
  exportCsv(@Query() query: QueryAppointmentDto) {
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusAppointmentDto, @CurrentUser() user: { id: string }) {
