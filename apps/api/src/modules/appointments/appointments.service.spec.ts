...
describe('AppointmentService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AppointmentService,
        { provide: getRepositoryToken(AppointmentSlot), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for appointments', async () => {
  ...
  it('should handle scenario 2 for appointments', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for appointments', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for appointments', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for appointments', async () => {
    repository.find.mockResolvedValue([]);
