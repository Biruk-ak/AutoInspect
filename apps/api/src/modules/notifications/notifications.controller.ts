...
export class NotificationController {
  ...
  @ApiOperation({ summary: 'Create notifications record' })
  create(@Body() dto: CreateNotificationDto, @CurrentUser() user: { id: string }) {
    return this.service.create(dto, user.id);
  }

  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create notifications records' })
  bulkCreate(@Body() dto: BulkCreateNotificationDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List notifications records' })
  ...
  @ApiOperation({ summary: 'Count notifications by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent notifications records' })
  recent(
  ...
  exportCsv(@Query() query: QueryNotificationDto) {
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusNotificationDto, @CurrentUser() user: { id: string }) {
