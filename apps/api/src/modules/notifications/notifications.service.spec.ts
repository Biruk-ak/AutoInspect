...
describe('NotificationService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        NotificationService,
        { provide: getRepositoryToken(NotificationMessage), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for notifications', async () => {
  ...
  it('should handle scenario 2 for notifications', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for notifications', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for notifications', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for notifications', async () => {
    repository.find.mockResolvedValue([]);
