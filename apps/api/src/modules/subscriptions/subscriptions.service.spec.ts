...
describe('SubscriptionService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        SubscriptionService,
        { provide: getRepositoryToken(SubscriptionPlan), useValue: repository },
      ],
    }).compile();
  ...
  it('should handle scenario 1 for subscriptions', async () => {
  ...
  it('should handle scenario 2 for subscriptions', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 3 for subscriptions', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 4 for subscriptions', async () => {
    repository.find.mockResolvedValue([]);
  ...
  it('should handle scenario 5 for subscriptions', async () => {
    repository.find.mockResolvedValue([]);
