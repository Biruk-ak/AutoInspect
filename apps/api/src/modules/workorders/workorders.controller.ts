...
export class WorkOrderController {
  ...
  @ApiOperation({ summary: 'Create workorders record' })
  ...
  @Post('bulk')
  @Roles('admin', 'garage')
  @ApiOperation({ summary: 'Bulk create workorders records' })
  bulkCreate(@Body() dto: BulkCreateWorkOrderDto, @CurrentUser() user: { id: string }) {
    return this.service.bulkCreate(dto, user.id);
  }

  @Get()
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'List workorders records' })
  ...
  @ApiOperation({ summary: 'Count workorders by status' })
  ...
  @Get('recent')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Recent workorders records' })
  recent(
  ...
  @ApiOperation({ summary: 'Export workorders as CSV' })
  exportCsv(@Query() query: QueryWorkOrderDto) {
  ...
  @Get(':id')
  @Roles('admin', 'inspector', 'garage', 'customer')
  @ApiOperation({ summary: 'Get workorders by id' })
  ...
  @ApiOperation({ summary: 'Update workorders' })
  update(
  ...
  @Post('bulk/status')
  @Roles('admin')
  bulkStatus(@Body() dto: BulkUpdateStatusWorkOrderDto, @CurrentUser() user: { id: string }) {
