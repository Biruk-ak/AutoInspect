...
export function isTerminalSettingsStatus(status: string): boolean {
  return ['completed', 'cancelled', 'archived', 'failed'].includes(status);
}

export function canTransitionSettings(from: string, to: string): boolean {
...
export function normalizeSettingsTags(tags: string[]): string[] {
