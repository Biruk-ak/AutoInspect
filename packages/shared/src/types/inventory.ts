...
export function isTerminalInventoryStatus(status: string): boolean {
  return ['completed', 'cancelled', 'archived', 'failed'].includes(status);
}

export function canTransitionInventory(from: string, to: string): boolean {
...
export function normalizeInventoryTags(tags: string[]): string[] {
